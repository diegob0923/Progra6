...
public partial class ProyectoSegurosEntities : DbContext
{
        ...
        : base("name=ProyectoSegurosEntities")
    {
        ...
        public virtual ObjectResult<RetornarUsuarioContrasena_Result> RetornarUsuarioContrasena(string usuario, string contrasena)
        {
        ...
        public virtual int sp_Insertar_Usuarios(Nullable<int> usuario, string contrasena, string tipoUsuario)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_Insertar_Usuarios", usuarioParameter, contrasenaParameter, tipoUsuarioParameter);
        }
        ...
        public virtual ObjectResult<sp_Retorna_Contrasenas_Sistema_Result> sp_Retorna_Contrasenas_Sistema(string contrasena)
        {
            var contrasenaParameter = contrasena != null ?
                new ObjectParameter("Contrasena", contrasena) :
                new ObjectParameter("Contrasena", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_Retorna_Contrasenas_Sistema_Result>("sp_Retorna_Contrasenas_Sistema", contrasenaParameter);
        }
        ...
        public virtual ObjectResult<sp_Retorna_Usuarios_Sistema_Result> sp_Retorna_Usuarios_Sistema(Nullable<int> usuario)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_Retorna_Usuarios_Sistema_Result>("sp_Retorna_Usuarios_Sistema", usuarioParameter);
        }
    ...
    public virtual ObjectResult<sp_Retorna_Tipo_Sistema_Result> sp_Retorna_Tipo_Sistema(string tipo_Usuario)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_Retorna_Tipo_Sistema_Result>("sp_Retorna_Tipo_Sistema", tipo_UsuarioParameter);
    }
    ...
    public virtual int sp_Insertar_Usuarios(Nullable<int> usuario, string contrasena, Nullable<int> idRol)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_Insertar_Usuarios", usuarioParameter, contrasenaParameter, idRolParameter);
    }
