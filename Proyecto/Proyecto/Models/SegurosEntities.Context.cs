...
namespace Proyecto.Models
{
    ...
    public partial class ProyectoSegurosEntities : DbContext
    {
        ...
        public virtual ObjectResult<sp_Retorna_Adiccion_Cliente_ID_Cliente_Result> sp_Retorna_Adiccion_Cliente_ID_Cliente(Nullable<int> cedula)
        {
            var cedulaParameter = cedula.HasValue ?
                new ObjectParameter("Cedula", cedula) :
                new ObjectParameter("Cedula", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_Retorna_Adiccion_Cliente_ID_Cliente_Result>("sp_Retorna_Adiccion_Cliente_ID_Cliente", cedulaParameter);
        }
